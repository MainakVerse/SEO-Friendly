...
export function HeroSection() {
    ...
    const animate = () => {
      ...
      for (let i = 0; i <= cols; i++) {
        ...
        for (let j = 0; j <= rows; j++) {
          ...
          // Warp effect based on mouse proximity
          let offsetX = 0
          let offsetY = 0
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted min-h-screen flex items-center">
      <canvas ref={canvasRef} className="absolute inset-0 w-full h-full pointer-events-auto" style={{ zIndex: 1 }} />
      ...
      <div className="container mx-auto px-4 relative" style={{ zIndex: 2 }}>
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button size="lg" className="w-full gap-2 sm:w-auto text-base px-8 py-6">
      ...
      <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-primary/10 blur-3xl" style={{ zIndex: 0 }} />
      <div
